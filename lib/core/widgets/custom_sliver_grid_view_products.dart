...
// class CustomSliverGridViewProducts extends StatelessWidget {
//   const CustomSliverGridViewProducts({super.key});
...
//               delegate: SliverChildBuilderDelegate(
//                 (BuildContext context, int index) {
//                   return CustomProductWidget(productModel: state.products[index]);
//                 },
...
//               child: Center(child: Text("Failed to load products: ${state.error}")),
//             );
//           }
//           return const SliverFillRemaining(
